...
**Change:** provider-resolution extraction, `quest/trust-and-change` · **Date:** 2026-09-21 · **Draft:** v3.1 (change log at end)
...
- v3 → v3.1 (third-reviewer cold read, fresh-context Opus, 2026-09-21): dangling `agents.md` reference fixed; review history brought up to date. Sign-off remains for Iqbal.
