...
- v3.1 → v3.2 (2026-09-22, factual pass, no review round): brief count 17 → 22 (five archived after v3.1: two `agents.md` rounds, two agent-proxy task prompts, the exercise-council brief); Opus launches 7 → 8 (exercise council); human row updated for the performed exercise and the sign-off.
