...
| B02 / 1h | Port [contract](../design/review-brief-contract.cjs), [role profile](../design/role-profile.json) and prompt into `src/lib/review-brief/`; add fixture loader | Authored inputs/outputs match the spec; malformed inputs and invalid citations fail; preserve version/hash provenance |
