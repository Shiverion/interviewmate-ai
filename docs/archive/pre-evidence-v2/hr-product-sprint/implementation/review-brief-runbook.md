...
[Documentation home](../../../../README.md) · [Phase 3 report](../../../../hr-product-sprint/phases/03-prototype-build.md) · [Build backlog](phase-3-backlog.md) · [AI contract](../design/ai-contract.md)
...
The candidate interview room now has separate [lightweight session-integrity guardrails](../../../../hr-product-sprint/implementation/session-integrity.md). Use its no-AI rehearsal to test tab-away events, warnings and candidate context; these events do not enter review-brief scoring or prompts.
...
|---|---|---|
| Request/output rules and quote validation | [Runtime contract](../../../../../src/lib/review-brief/contract.ts) | [Offline design contract](../../../../hr-product-sprint/design/review-brief-contract.cjs), versioned fixtures and both test suites |
| Criteria, questions and evidence anchors | [Runtime role profile](../../../../../src/lib/review-brief/role-profile.json) | [Design role profile](../../../../hr-product-sprint/design/role-profile.json) and its version |
...
The [first real provider attempt](../../../../hr-product-sprint/implementation/verification/2026-09-08-provider-attempt.json) is a selected, tracked copy of a failed run. No model output or usage was returned. Its contract hash reflects the source at that attempt, before subsequent source formatting. Do not overwrite this failure when access is fixed; preserve the next attempt separately.
